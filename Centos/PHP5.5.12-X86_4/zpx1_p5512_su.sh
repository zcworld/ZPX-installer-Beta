...
yum install -y proftpd proftpd-mysql ld-linux.so.2 libbz2.so.1 libdb-4.7.so libgd.so.2  curl curl-devel perl-libwww-perl libxml2 libxml2-devel mysql-server zip webalizer gcc gcc-c++ httpd-devel at make mysql-devel bzip2-devel postfix postfix-perl-scripts bash-completion dovecot dovecot-mysql dovecot-pigeonhole mysql-server proftpd proftpd-mysql bind bind-utils bind-libs



rpm -e --justdb --nodeps openssl
rpm -ivh --force http://mirror.centos.org/centos/6.5/updates/x86_64/Packages/openssl-1.0.1e-16.el6_5.4.x86_64.rpm
yum -y install  httpd php55u php55u-suhosin php55u-devel php55u-gd php55u-mbstring php55u-mcrypt php55u-intl php55u-imap php55u-mysql php55u-xml php55u-xmlrpc curl curl-devel perl-libwww-perl libxml2 libxml2-devel php55u-pecl-jsonc.x86_64 --setopt=protected_multilib=false
